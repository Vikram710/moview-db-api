...
function load(){
    ...
    console.log(result);
    xhr.open('GET','http://www.omdbapi.com/?t='+title+'&apikey=e98d7e11&type=series',true);
    ...
    xhr.onload=function(){
        if(this.status==200 && title.length>0){
            ...
            var director='Number of seasons: '+movie.totalSeasons+'<br>';
    ...
    xhr1.open('GET','https://api.themoviedb.org/3/search/tv?api_key=a488dee721f2e2b9a285f7aa50bd95d5&language=en-US&query='+title+'',true);
    xhr1.onload=function(){ 
        if(this.status==200 && title.length>0){
            ...
            console.log(id)
            xhr2.open('GET','http://api.themoviedb.org/3/tv/'+id+'/videos?api_key=a488dee721f2e2b9a285f7aa50bd95d5',true);
