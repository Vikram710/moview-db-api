...
<div class="main">
        ...
        <input type="text" id="title" placeholder="Type the tv-show name" required>
        <button id="button" onclick="load()">load</button> 
        <div id="movie"></div>
        <form action="includes/like.inc.php" method="POST" hidden id="sea">
